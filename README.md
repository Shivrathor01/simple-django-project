...
#### 1. Install Python
Install ```python-``` and ```python-pip```. Follow the steps from the below reference document based on your Operating System.
Reference: [https://docs.python-guide.org/starting/installation/](https://docs.python-guide.org/starting/installation/)

#### 2. Install MySQL
Install ```mysql```. Follow the steps form the below reference document based on your Operating System.
